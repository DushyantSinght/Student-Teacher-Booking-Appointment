...
import {
  initializeFirestore,  // ✅ use this instead of getFirestore
  query,
  getDocs,
  collection,
  where,
...
// ✅ Fix Firestore connection with long-polling config
...
// ✅ Realtime Database
const rb = getDatabase(app, "https://studentteacherbooking-ce0cd-default-rtdb.firebaseio.com");
